...
초보와 프로 모두가 십분 활용할 수 있는 앱과 함께라면 iPad가 음악 스튜디오로 변신합니다.

고퀄리티 샘플 팩으로 무장한 작곡 앱부터, 보컬과 비트를 정교하게 분리해주는 똑똑한 디제잉 앱까지 최고만 모았습니다.
"""),
...
iPad의 환상적인 동반자 Apple Pencil. 다양한 앱과 함께라면 Apple Pencil은 명화를 그리는 페인트 브러시가 되기도 하고, 강의의 핵심을 놓치지 않는 똑똑한 필기도구가 되기도 합니다.

Apple Pencil과 최고의 궁합을 보여주는 아래 앱들을 확인해보세요.
""")
                     ]),
...
복잡하고 강력한 암호를 만드는 것의 중요성이 점점 커지는 요즘. 〈1Password〉가 당신의 스트레스와 걱정을 덜어줄 겁니다.
"""),
                        DetailUnit(title: "마스터 비밀번호로 개인정보를 안전하게 관리하세요.", emoji: "🔑", paragraph: """
〈1Password〉는 당신의 개인정보를 한데 모아 쉽게 관리하도록 도와줍니다. 다양한 소셜 미디어나 웹사이트의 로그인 정보나 비밀 메모를 적어둘 수 있는 노트장, 신용 카드, 신분증을 등록할 수 있죠.

각종 특수문자와 대소문자 구분을 이용해 더욱 안전한 비밀번호를 새롭게 만들어 주기도 합니다.
"""),
...
또는 꼭 필요한 알림만 받도록 설정한 뒤 업무를 마무리하거나, 느긋하게 저녁 식사를 즐길 수 있죠.
""")
                     ]),
...
〈ALLO - 비주얼 캔버스〉는 많은 이들이 원격 근무를 할 수 있도록 도와줍니다.
"""),
...
필름 카메라를 연상케 하는 앱부터 문방구에서 사 읽던 두꺼운 만화 잡지를 모티프로 삼은 앱, 그리고 호주머니에 넣고 다니던 다마고치 게임기를 닮은 게임까지.
...
한 글자, 한 글자 눌러쓰며 원고지를 채워가는 쾌감. 〈백자 하루〉에 나의 일상을 매일매일 기록하며 직접 경험해보세요.
"""),
                        DetailUnit(title: "Paper", emoji: "📃", paragraph: """
그림을 그리는 스케치북, 필기를 하는 공책, 혹은 일상을 기록하는 일기장. 〈Paper〉에 마련된 ‘저널’은 그 무엇이든 될 수 있습니다.

저널의 표지부터 종이 재질까지 취향에 맞춰 설정할 수 있죠. 묵직한 연필, 시원시원한 마커 등등 다양한 도구도 마련되어 있으니, 창의력을 마음껏 발휘해보세요.
""")
                     ]),
...
만보기 앱은 거창할 필요가 없습니다. 오늘 내가 얼마나 걸었고, 칼로리는 얼마나 소모했는지, 목표량을 채우려면 얼마나 더 움직여야 하는지 쉽게 확인할 수 있으면 되죠.

가독성 좋고 기본기에 충실한 〈StepsApp〉이 적절할 것 같군요.
"""),
