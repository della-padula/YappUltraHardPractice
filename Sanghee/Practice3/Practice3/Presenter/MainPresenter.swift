...
class MainPresenter: MainViewPresenter {
    ...
    func getMainUnits() {
        mainUnits = [
            MainUnit(title: "오늘의 앱", subTitle: "사진 찍기", backgroundColor: .systemBlue, paragraph: """
...
"""),
            MainUnit(title: "Apple Watch와 뛰어요", subTitle: "건강한 삶", backgroundColor: .systemOrange, paragraph: """
러닝에 온전히 집중하고 싶은 당신.

Apple Watch를 통해 모든 걸 해결할 수 있습니다. 바깥 날씨와 미세 먼지 농도도, 달릴 때 속도와 거리, 러닝 시간도 손목 위에서 바로 확인할 수 있거든요. 앱에 맡겨두고 오직 달리는 거에만 몰입해보세요.
"""),
            MainUnit(title: "세계에서 가장 달콤한 왕국", subTitle: "지금 경험하세요", backgroundColor: .brown, paragraph: """
어디서 달콤한 냄새 안 나요?
...
"""),
            MainUnit(title: "추억 속으로", subTitle: "지금 경험하세요", backgroundColor: .systemGray, paragraph: """
어릴 적 즐기던 바로 그 게임!

마리오와 달리고, 레이맨이 되어 환상적인 모험을 즐기고, 소닉과 쌩쌩 달리던 추억속으로 다시 들어가보세요. 시간이 흐른 지금, 사뭇 다른 기분이 들지도 몰라요.
"""),
            MainUnit(title: "악기 하나쯤 배웁시다", subTitle: "시작하기", backgroundColor: .systemPurple, paragraph: """
골라보세요. 기타인가요? 피아노인가요?
...
"""),
            MainUnit(title: "여기가 화성이라고?", subTitle: "추천 게임", backgroundColor: .systemRed, paragraph: """
화성으로 떠나 봅시다.
